...
public class Distribuidor {
    ...
    private static final String[] IPS_SERVIDORES = {"26.26.172.176", "26.13.4.83"};
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.print("Digite o tamanho do vetor grande: "); // maior tamanho = 1477891713
            ...
            System.out.println("2. O número 111 (para testar nenhuma ocorrência)");
    ...
    private static void executarContagemDistribuida(byte[] vetor, byte procurado) {
        ...
        for (int i = 0; i < numServidores; i++) {
            ...
            Pedido pedido = new Pedido(chunk, procurado);
